...
class CategoriesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $users = \App\User::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$clubs = \App\Club::where('category_id', $id)->get();

        $category = Category::findOrFail($id);

        return view('admin.categories.show', compact('category', 'clubs'));
    }
