@foreach($club->comments->sortByDesc('created_at') as $comment)
<div class="card-body">
    <div class="row">
        <div class="col-md-2">
            <img src="/storage/images/avatars/{{ $comment->user->avatar }}" class="img rounded-circle img-fluid float-right" style="height: 7em; width: 7em" />
        </div>
        <div class="col-md-8">
            <p>
